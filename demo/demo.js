...
function initPlayers() {
  ...
  window.dp2 = new DPlayer({
    ...
    video: {
      ...
      thumbnails: 'https://i.loli.net/2019/06/06/5cf8c5d9cec8510758.jpg',
      type: 'auto',
      // url:"http://localhost:8000/live/52.flv",
      // pic: 'https://i.loli.net/2019/06/06/5cf8c5d9c57b510947.png',
      // thumbnails: 'https://i.loli.net/2019/06/06/5cf8c5d9cec8510758.jpg',
      // type: 'customFlv',
      // customType:{
    ...
    apiBackend: {
      read: (options) => {
        axios.get('http://localhost:3000/danmaku/list?vid=300').then((res) => {
          options.success(res.data.data)
        })
      },
      send: (options) => {
        const { color, text, time, type } = options.data
        console.log(options)
        axios
          .post('http://localhost:3000/danmaku/send', {
            uid: 51,
            vid: 300,
            color,
            text,
